games = Game.create([
  ...
  { host_id: 2, title: "Game 4", no_players: 3, turn: "red", round: 1, phase: "move", status: "pending" },
  { host_id: 2, title: "Game 5", no_players: 3, turn: "red", round: 1, phase: "move", status: "pending" },
  { host_id: 2, title: "Game 6", no_players: 3, turn: "red", round: 1, phase: "move", status: "pending" },
  { host_id: 3, title: "Game 7", no_players: 2, turn: "red", round: 1, phase: "move", status: "pending" },
  { host_id: 3, title: "Game 8", no_players: 2, turn: "red", round: 1, phase: "move", status: "pending" },
